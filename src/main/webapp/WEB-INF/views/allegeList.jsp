...
<html>
  <head>
    ...
    <link href="style/css/styleforlist.css" rel="stylesheet">
...
<div class="container" style="padding-top:30px;height:100%;weight:80%;">
	<div class="content">
		...
		<div class="wrapper">
			...
			<div>
					...
					<div class="well">
						<form class="form-inline" role="form" id="query">
							<div class="form-group" style="margin-right:10px">
								<label>申述人:</label>
								<input type="text" class="form-control" name="email" id="email_label" maxlength="128" placeholder="电子邮箱">
							</div>
				...
				<!--处理申述 弹出-->
				<%--aria-labelledby屏幕阅读器读，指内容的div--%>
				<div class="modal fade" id="dealModal" role="dialog"
					aria-labelledby="myModalLabel" aria-hidden="true"> <%--隐藏--%>
							...
							<div class="modal-body">
								<div class="well">
									...
									<div id="failUpd" class="alert alert-warning">
									 <button type="button" class="close" id="close_false"   aria-hidden="true">
                                      &times;
                                     </button>
										<strong>处理失败！</strong>
									</div>
    ...
    $("#chkAll").click(function(){
    	...
    	$.post('listAllege.do',
    	       ...
    	       function(response){
    	    	 //生成结果列表
    			 initDataTable("userTable", 6, ["email","allEmail","allState"], response.page,
        	...
        	$.post("getAllegeById",{"id":id},function(response){
                   ...
                   if(response.Allege.allState=="已处理"){
                       alert("该申述已处理！");
                        ...
                        $("label.error").remove(); //清除验证
                        $("div#dealModal #sucUpd").hide(); //隐藏
                        $("div#dealModal #failUpd").hide();
                        $("#dealModal").modal('show');
                           //设置表单验证
                    	$("#dealForm").validate({
                    			  onkeyup:false,  //验证是否有输入，根据键盘按键动作（松开）验证
