...
%>
 ...
 <html>
 	<head>
 		...
 		<title>毕过兼职网-公司主页</title>
 		<meta name="description" content="毕过兼职网-公司主页">
 		<meta name="keywords" content="毕过兼职网-公司主页">
 			...
 			<div id="header">
 				<div class="wrapper">
 					<a class="logo" href="index">
 						<img width="229" height="43" alt="毕过兼职网-公司主页" src="style/images/logo.png">
 					</a>
 					<ul id="navheader" class="reset">
 						<li><a href="index">首页</a></li>
 						<li><a rel="nofollow" onclick="checkCompany()">兼职招聘</a></li>
 									...
 									<table>
 										<tbody>
 											...
 											<tr>
 												...
 												<td>
 													<input type="hidden" value="移动互联网" id="industryField"
 														name="industryField" class="valid">
 													<input type="button" value="移动互联网" id="select_ind"
 														class="select_tags">
 											...
 											<tr>
 												<td>规模</td>
 												<td>
 													<input type="hidden" value="少于15人" id="companySize"
 														name="companySize" class="valid">
 													<input type="button" value="少于15人" id="select_sca"
 														class="select_tags">
