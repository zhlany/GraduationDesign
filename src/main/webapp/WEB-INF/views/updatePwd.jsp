...
%>
 ...
 <html>
 	<head>
 		...
 		<title>修改密码-毕过兼职网</title>
 		<meta content="23635710066417756375" property="qc:admins">
 		<meta name="description" content="大学生兼职平台-毕过兼职网">
 		<meta name="keywords" content="大学生兼职平台-毕过兼职网">
 			...
 			<div id="header">
 				<div class="wrapper">
 					...
 					<ul id="navheader" class="reset">
						...
						<li><a href="updatePwd" rel="nofollow">账号设置</a></li>
 					</ul>
 								...
 								<table class="savePassword">
 									<tbody>
 										...
 										<tr>
 											...
 											<td>
 												<input type="password" maxlength="16" id="oldPassword"
 													name="oldPassword"
 										...
 										<tr>
 											...
 											<td><input type="password" maxlength="16" id="firmPassword"
 													name="firmPassword"
 													style="background-image: url(style/images/img/a6y3y0Wx5kbFHvGuXzkgf0xhKnPzA4UTyaTB8Ph8AvcHi3fnsrZ7Wore02YViqVOrRXXPhfqP8j6MYlawoAAAAASUVORK5CYII=quot); background-repeat: no-repeat; background-attachment: scroll; background-position: right center;">
 											</td>
 										</tr>
